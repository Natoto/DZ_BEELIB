...
// DZ_BEELIB
#define COCOAPODS_POD_AVAILABLE_DZ_BEELIB
#define COCOAPODS_VERSION_MAJOR_DZ_BEELIB 0
#define COCOAPODS_VERSION_MINOR_DZ_BEELIB 0
#define COCOAPODS_VERSION_PATCH_DZ_BEELIB 2

// DZ_BEELIB/Core
#define COCOAPODS_POD_AVAILABLE_DZ_BEELIB_Core
#define COCOAPODS_VERSION_MAJOR_DZ_BEELIB_Core 0
#define COCOAPODS_VERSION_MINOR_DZ_BEELIB_Core 0
#define COCOAPODS_VERSION_PATCH_DZ_BEELIB_Core 2
